...
import { fmtMoney, escHtml, formatDate, todayStr, toast,
         getWeekStart, isContadoPlan, calcIncentiveSemanal,
         calcMedallasSemanales, calcTotalMedallas, calcNivel,
         calcMonthComision, groupByWeek } from '../../js/utils.js';
...
export async function deleteSale(id) {
  ...
  await sales.delete(id); toast('Venta eliminada'); render();
}
