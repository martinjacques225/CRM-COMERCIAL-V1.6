...
export function installPWA() {
  if (S.deferredInstall) { S.deferredInstall.prompt(); S.deferredInstall.userChoice.then(() => { S.deferredInstall = null; renderNav(); }); }
}

// Helper privado — evita importar formatDateLong en ui.js desde utils.js (ya está ahí)
function _formatDateLong(str) {
  if (!str) return '';
